...
plt.plot(prefs_avg, label='Comparison', color=pairwise_color, linewidth=2.5)
...
plt.savefig('C:/Users/Rosies/Desktop/Things/LiraLab/CoRL_2025/figures/avg_ratings.pdf')
