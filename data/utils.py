...
greater_gtreward_adjs = ["better", "more successfully", "improve", "greater success"]
less_gtreward_adjs = ["worse", "not as well", "diminish your proficiency", "less effectively", "decrease the efficiency"]
